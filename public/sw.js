const CACHE='fieldmaster-shell-v25';
const SHELL=['/','/index.html','/admin.html','/staff.html','/styles.css?v=19','/app.js?v=24','/geo.js?v=1','/field-input.js?v=1','/vendor/leaflet/leaflet.css','/vendor/leaflet/leaflet.js','/manifest.webmanifest','/admin.webmanifest','/staff.webmanifest','/icon.svg','/icon-player-192.png','/icon-player-512.png','/icon-staff-192.png','/icon-staff-512.png','/icon-admin-192.png','/icon-admin-512.png'];
