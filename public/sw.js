const CACHE='fieldmaster-shell-v16';
const SHELL=['/','/index.html','/styles.css?v=11','/app.js?v=16','/geo.js?v=1','/vendor/leaflet/leaflet.css','/vendor/leaflet/leaflet.js','/manifest.webmanifest','/icon.svg','/icon-192.png','/icon-512.png'];
