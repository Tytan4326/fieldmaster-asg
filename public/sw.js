const CACHE='fieldmaster-shell-v12';
const SHELL=['/','/index.html','/styles.css?v=9','/app.js?v=12','/vendor/leaflet/leaflet.css','/vendor/leaflet/leaflet.js','/manifest.webmanifest','/icon.svg'];
